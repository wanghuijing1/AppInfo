		...
		<div class="x_panel">
            ...
            <div class="clearfix"></div>
				...
				<form class="form-horizontal form-label-left"
					action="${pageContext.request.contextPath}/appinfoaddsave.do"
								...
								<c:if test="${flatFormList != null }">
									...
									<c:forEach var="dataDictionary" items="${flatFormList }">
										<option
											...
											value="${dataDictizsonary.valueId }">${dataDictionary.valueName }</option>
									</c:forEach>
								</c:if>
							</select>
						</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<select name="categoryLevel2" id=categoryLevel2
								...
								<c:if test="${categoryLevel2 != null }">
									<option value="" selected="selected">--请选择--</option>
									<c:forEach var="appCategory" items="${categoryLevel2 }">
										<option
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<select name="categoryLevel3" id="categoryLevel3"
								class="form-control" required="required">
								<c:if test="${categoryLevel3 != null }">
									<option value="" selected="selected">--请选择--</option>
									<c:forEach var="appCategory" items="${categoryLevel3 }">
										<option
